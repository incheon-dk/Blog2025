...
The sentiment was immortalized over a millennium by the Tang Dynasty poet Li He 李贺（790—816 AD), who wrote:
...
It is tempting to not get involved and withdraw from the current situation and the society.
...
We are called to make the transition from the earthly and temporal to the heavenly and celestial.

This transition requires a fundamental shift in our emotional architecture.
